...
<main>
    <section class="banner">
        <img src="../images/diplome.png" alt="Bannière" class="banner-img">
    ...
    <section>
        ...
        <article class="tarif-card">
            ...
            <p class="price">35 €</p>
            <a href="../php/paiement.php?type=domicile" class="btn">Payer</a>
        </article>
        ...
        <article class="tarif-card">
            ...
            <p><strong>Séance de 1h30</strong></p>
            <p class="price">30 €</p>
            <a href="../php/paiement.php?type=enligne" class="btn">Payer</a>
        </article>
        ...
        <article class="tarif-card">
            ...
            <p class="price">150 €</p>
            <a href="../php/paiement.php?type=forfait_enligne" class="btn">Payer</a>
        </article>
        ...
        <article class="tarif-card">
            ...
            <p><strong>2 créneaux / semaine</strong><br>pendant 1 mois</p>
            <p class="price">200 €</p>
            <a href="../php/paiement.php?type=forfait_domicile" class="btn">Payer</a>
        </article>
    </section>
